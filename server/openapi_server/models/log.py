...
class Log(Model):
    ...
    def __init__(self, name=None, cmd=None, start_time=None, end_time=None, stdout=None, stderr=None, exit_code=None, output=None):  # noqa: E501
        ...
        :type exit_code: int
        :param output: The output of this Log.  # noqa: E501
        :type output: str
        """
        self.openapi_types = {
            'name': str,
    ...
    @property
    def output(self):
        """Gets the output of this Log.

        Output of workflow  # noqa: E501

        :return: The output of this Log.
        :rtype: str
        """
        return self._output
    ...
    def output(self, output):
        """Sets the output of this Log.

        Output of workflow  # noqa: E501

        :param output: The output of this Log.
        :type output: str
        """
